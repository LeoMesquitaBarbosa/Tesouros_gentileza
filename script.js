const quizData = {
  questions: [
    { id: 1, value: "Gentileza", question: "Um colega deixou cair os lápis no chão. O que demonstra gentileza?", alternatives: [{ text: "Ajudar a recolher e entregar com cuidado.", correct: true }, { text: "Rir e continuar andando.", correct: false }, { text: "Esperar outra pessoa ajudar.", correct: false }, { text: "Pegar um lápis para você.", correct: false }], explanation: "A gentileza aparece quando percebemos uma necessidade e fazemos algo bom sem esperar recompensa." },
    { id: 2, value: "Atenção", question: "Durante uma explicação, qual atitude ajuda a aprender melhor?", alternatives: [{ text: "Escutar, olhar para quem fala e pensar no assunto.", correct: true }, { text: "Conversar sobre outro tema.", correct: false }, { text: "Responder antes de entender.", correct: false }, { text: "Ficar mexendo nos materiais sem parar.", correct: false }], explanation: "A atenção consciente une escuta, pensamento e vontade de compreender." },
    { id: 3, value: "Gratidão", question: "Alguém te ajudou em uma tarefa difícil. O que combina com gratidão?", alternatives: [{ text: "Agradecer e lembrar do bem recebido.", correct: true }, { text: "Fingir que fez tudo sozinho.", correct: false }, { text: "Dizer que a ajuda não serviu.", correct: false }, { text: "Pedir outra ajuda sem agradecer.", correct: false }], explanation: "A gratidão reconhece o bem que recebemos e aproxima as pessoas." },
    { id: 4, value: "Respeito", question: "Se um amigo pensa diferente de você, qual é a melhor atitude?", alternatives: [{ text: "Ouvir com calma e falar sem ofender.", correct: true }, { text: "Interromper até ele mudar de ideia.", correct: false }, { text: "Dizer que só você está certo.", correct: false }, { text: "Sair bravo sem conversar.", correct: false }], explanation: "Respeitar não significa concordar sempre, mas tratar o outro com consideração." },
    { id: 5, value: "Colaboração", question: "Em um trabalho em grupo, como colaborar de verdade?", alternatives: [{ text: "Fazer sua parte e ajudar o grupo a se organizar.", correct: true }, { text: "Deixar tudo para os colegas.", correct: false }, { text: "Mandar em todos sem escutar.", correct: false }, { text: "Escolher só a parte mais fácil e sumir.", correct: false }], explanation: "Colaboração é unir esforços para alcançar um bem comum." },
    { id: 6, value: "Generosidade", question: "Você percebe que um colega esqueceu o lanche. O que pode ser generoso?", alternatives: [{ text: "Oferecer uma parte, se for possível, com alegria.", correct: true }, { text: "Mostrar seu lanche para deixá-lo com vontade.", correct: false }, { text: "Esconder o lanche de todos.", correct: false }, { text: "Dizer que o problema não é seu.", correct: false }], explanation: "Generosidade é compartilhar algo bom quando podemos ajudar." },
    { id: 7, value: "Empatia", question: "Uma criança nova chegou à turma e parece tímida. O que mostra empatia?", alternatives: [{ text: "Convidá-la para brincar e explicar como a turma funciona.", correct: true }, { text: "Ignorar porque ela ainda não tem amigos.", correct: false }, { text: "Fazer perguntas para deixá-la sem graça.", correct: false }, { text: "Esperar que ela se vire sozinha.", correct: false }], explanation: "Empatia é tentar perceber como o outro se sente e agir com cuidado." },
    { id: 8, value: "Esforço", question: "Você errou uma atividade. Qual pensamento ajuda mais?", alternatives: [{ text: "Posso tentar de novo e aprender com o erro.", correct: true }, { text: "Nunca vou conseguir.", correct: false }, { text: "Vou esconder para ninguém ver.", correct: false }, { text: "A culpa é sempre dos outros.", correct: false }], explanation: "O esforço transforma dificuldades em oportunidades de crescimento." },
    { id: 9, value: "Aprendizagem", question: "O que é aprender de forma consciente?", alternatives: [{ text: "Entender, praticar e usar o que aprendeu para fazer melhor.", correct: true }, { text: "Decorar sem pensar.", correct: false }, { text: "Copiar respostas depressa.", correct: false }, { text: "Estudar só quando alguém manda.", correct: false }], explanation: "A aprendizagem consciente envolve pensar sobre o que se aprende." },
    { id: 10, value: "Gentileza", question: "Na fila, alguém empurrou sem querer. Qual resposta é mais gentil?", alternatives: [{ text: "Dizer com calma: tudo bem, vamos cuidar do espaço.", correct: true }, { text: "Empurrar de volta.", correct: false }, { text: "Gritar para todos ouvirem.", correct: false }, { text: "Guardar raiva o dia inteiro.", correct: false }], explanation: "A gentileza também aparece quando respondemos com equilíbrio." },
    { id: 11, value: "Atenção", question: "Antes de atravessar uma rua com um adulto, o que é importante fazer?", alternatives: [{ text: "Parar, olhar, escutar e seguir com cuidado.", correct: true }, { text: "Correr sem olhar.", correct: false }, { text: "Atravessar olhando para o celular.", correct: false }, { text: "Ir porque outros foram.", correct: false }], explanation: "A atenção protege e ajuda a escolher o momento certo." },
